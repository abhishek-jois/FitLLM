...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_train.add_argument("--lora-rank", type=int, default=16, help="LoRA rank")
    p_train.add_argument("--grad-accum", type=int, default=8, help="Gradient accumulation steps")
    p_train.add_argument("--steps", type=int, default=1000, help="Max training steps")
